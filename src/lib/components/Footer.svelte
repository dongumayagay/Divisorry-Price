<footer class="bg-neutral-900 absolute bottom-0 h-[125px] w-full grid place-items-center p-4">
	...
	>
		<nav class=" text-neutral-300 flex justify-around md:space-x-7">
			...
			<a sveltekit:prefetch href="/contact" class="hover:text-yellow-500 transition-colors"
				>Contact</a
			>
		</nav>
		<p class="text-neutral-500 text-center">Copyright © 2021 Divisorry Price All Rights Reserved</p>
	</div>
</footer>
